...
//            ed.apply();
    ...
    public void ulpBypass(boolean on) {
        mPlayer.ulpBypass(on);
    }
    ...
    private class MultiPlayer {
        ...
        private boolean mUlpBypass = false;    /* SLSI_ULP_AUDIO: ULP Bypass */
        ...
        public void setDataSource(String path) {
            try {
                ...
                /* SLSI_ULP_AUDIO: ULP Bypass */
                mMediaPlayer.ulpBypass(mUlpBypass);
